                                                            ...
                                                            <div className="mt-3 md:mt-4 grid grid-cols-1 gap-2">
                                                                 {card?.address && (
                                                                    <div className="flex items-center gap-x-2">
                                                                        <BiMap className="min-w-4 min-h-4 rounded-sm text-[#B90B0B]"></BiMap>
                                                                        <span
                                                                        rel="noopener noreferrer"
                                                                        className="text-sm font-normal text-white hover:text-[#B90B0B] transition-colors truncate"
                                                                        >
                                                                        {card?.address ?? ""}
                                                                        </span>
                                                                    </div>
                                                                ...
                                                                {card?.link?.website && (
                                                                    <div className="flex items-center gap-x-2">
                                                                        <BiGlobe className="min-w-4 min-h-4 rounded-sm text-[#B90B0B]"></BiGlobe>
                                                                        <span
                                                                        rel="noopener noreferrer"
                                                                ...
                                                                {card?.link?.email && (
                                                                    <div className="flex items-center gap-x-2">
                                                                        <CgMail className="min-w-4 min-h-4 rounded-sm text-[#B90B0B]"></CgMail>
                                                                        <span
                                                                        className="text-sm font-normal text-white hover:text-[#B90B0B] transition-colors truncate max-w-[150px]"
                                                                        >
                                                                        {card?.link?.email ?? ""}
